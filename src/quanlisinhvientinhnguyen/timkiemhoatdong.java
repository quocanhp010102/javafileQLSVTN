 ...
 * @author PC
 */
public class timkiemhoatdong extends javax.swing.JDialog {
    ...
    public timkiemhoatdong(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        //fakeTV();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(timkiemhoatdong.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                QLHoatDong danhSachTV = new QLHoatDong();
                timkiemhoatdong dialog = new timkiemhoatdong(danhSachTV, true);
